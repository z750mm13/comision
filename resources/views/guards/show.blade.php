...
<div class="row">
  <div class="col-md-10">
    ...
    <div class="row">
      <div class="col-md-2">
          <img src="{{\Tools\Img\ToServer::getFile($guard->cordinate->element->foto)}}" alt="avatar" class="rounded-circle" style="width: 10rem;">
      </div>
      <div class="col-md-9 offset-md-1 col-sm-12">
          <h1 class="display-4">{{$guard->cordinate->element->nombre." ".$guard->cordinate->element->apellidos}}</h1>
