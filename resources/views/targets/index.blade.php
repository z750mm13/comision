@extends('layouts.content.default.index',[
    ...
    'descriptions' => [
      ...
      __('En este apartado se podrá tener el control de las asignaciónes de tipos para todas las áreas la institución. Para asignar un tipo al área presione el sigiente botón o el botón + de cada área.')
    ],
    'titlebody' => __('Tipos'),
    'image' => null,
