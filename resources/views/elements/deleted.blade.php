@extends('layouts.content.default.index',[
    'title' => 'Integrantes eliminados',
    'descriptions' => [
      __('Integrantes eliminados'),
...
<li class="breadcrumb-item active" aria-current="page">Integrantes eliminados</li>
@endpush
...
@section('bodycontent')
<form action="/elements/restore" method="Post" id="restore-form">
  {{csrf_field()}}
  {{method_field('POST')}}
